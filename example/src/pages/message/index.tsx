...
export default () => {
  ...
  return (
    <Fragment>
      <ReactMarkdown
        source={require('!!raw-loader!./message.md').default}
        className="md"
      />
      <CodeCard
        title="基础用法"
      ...
      >
        <div style={{ marginBottom: '20px' }}>
          ...
          <Button type="reverse" onClick={handleError}>
            错误
          </Button>
          <Button type="danger" onClick={handleWarn}>
            警告
          </Button>
        </div>
      </CodeCard>
      ...
      >
        <div style={{ marginBottom: '20px' }}>
          <Button type="success" onClick={handleTime}>
            10秒钟后关闭
          </Button>
          <Button type="reverse" onClick={handleTop}>
            距离顶部300px
          </Button>
          <Button type="danger" onClick={handleCallback}>
            执行关闭后的回掉函数
          </Button>
        </div>
      </CodeCard>
