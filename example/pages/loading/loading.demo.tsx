...
export default () => {
  return <Fragment>
    ...
    <CodeCard
      ...
      code={` 
        <Loading size="large" style={{marginRight: '20px'}} name="spin"/>`
      }
    >
      <div style={{ width: '50px', height: '50px' }}>
        <Loading size="large" name="spin" />
      </div>
    </CodeCard>
    <CodeCard
      title="各种大小"
      ...
      code={` 
        <Loading size="small" name="spin"/>
        <Loading size="medium" name="spin"/>
        <Loading size="large" name="spin"/>`
      }
    >
    ...
    <CodeCard
      ...
      summary="作为一个容器包裹内容"
      code={` 
        <Loading size="small" name="spin" message="Loading...">
